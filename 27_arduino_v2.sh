...
install_packages () {
    ...
    rm -rf /home/$LOGNAME/Arduino
    mkdir /home/$LOGNAME/Arduino
    cd /home/$LOGNAME/Arduino
    ...
    sed -i '/#ARDUINO_V2_0/c\export PATH=$PATH:$HOME/Arduino/arduino-ide' /home/$LOGNAME/.shrc
}
